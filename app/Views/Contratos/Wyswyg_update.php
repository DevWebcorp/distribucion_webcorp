        ...
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <form method="POST" action="<?php echo base_url().'/contratos/update_wyswyg'?>">
              ...
              <div class="row">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" value="<?php echo $get_wyswyg['name']?>" class="form-control" name="name" placeholder="Enter name">
                </div>
              </div><!-- row -->
              <div class="row">
                <label class="col-sm-4 form-control-label">Seleciona: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  ...
                  <input type="hidden" name="id_contract"  value="<?php echo $get_wyswyg['id'];?>">
                </div>
              </div><!-- row -->
              <div class="row">
              ...
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Generacion de contrato: <span class="tx-danger">*</span></label>
                  ...
                  <textarea id="txt" class="txt" name="txt" placeholder="Type in some Text...." class=" tail-writer-editor txt" data-tail-writer="tail-2"><?php echo $get_wyswyg['wyswyg'];?>
                  </textarea>
