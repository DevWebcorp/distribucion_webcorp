    ...
    <nav class="breadcrumb sl-breadcrumb">
        <?php 
            ...
            foreach($parent as $breadcrumb){
                ...
                echo ('<a class="breadcrumb-item"  href="'.base_url()."/".$breadcrumb->controller.'">Marketing Campañas</a>');
                echo ('<a class="breadcrumb-item"  href="'.base_url()."/".$breadcrumb->parent.'">Marketing Graficas</a>');
