...
class Contratos extends BaseController
{
    ...
    //Aqui es cuando consigo los datos para actualizar
    public function get_to_update_contract($id){
        helper('menu');
        $session = session();
        $data_left['menu'] = get_menu();
        ...
        $entity_model_wyswyg=model('App\Models\Model_contracts\Wyswyg',false);
        $data['get_wyswyg']=$entity_model_wyswyg->where('id',$id)->first();
        echo view('header' , $data_header);
        echo view('left_panel' , $data_left);
        echo view('head_panel');
        echo view('Contratos/Wyswyg_update',$data);
        echo view('right_panel');
        echo view('fotter_panel' , $data_fotter);
    ...
    public function update_wyswyg(){
        ...
        $id=$_POST['id_contract'];
                ...
                $entity_model=model('App\Models\Model_contracts\Wyswyg',false);
