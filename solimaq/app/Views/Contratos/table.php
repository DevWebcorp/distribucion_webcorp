          ...
          <div class="sl-pagebody">
              <div class="card pd-20 pd-sm-40">
                  ...
                  <p class="mg-b-20 mg-sm-b-30">Listado de contratos creados</p>
                   ...
                   <div class="col-md-2">
                       <button class="btn btn-success pd-x-20" style="margin-bottom: 10px;"><a style="color:white" href="<?php echo base_url().'/contratos'?>">Agregar nuevo contrato</a></button>
                       <br>
                    </div>
                      ...
                      <table id="datatable1" class="table display responsive nowrap">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td><button type="submit" id="<?php echo $key['id'];?>" class="btn btn-danger pd-x-20 btn-delete">Eliminar contrato</button>
                                    <button type="submit" id="<?php echo $key['id'];?>" class="btn btn-primary pd-x-20"><a href="<?php echo base_url().'/contratos/get_to_update_contract/'.$key['id']?>" style="color: white;">Actualizar</a></button>
                                  </td>
