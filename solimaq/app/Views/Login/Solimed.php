...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>/../../assets/css/solimaq.css">
  </style>
</head>

<body>

  <div class="d-flex align-items-center justify-content-center bg-solimed ht-100v">
    <div class="login-wrapper wd-300 wd-xs-450 pd-25 pd-xs-40 bg-white">
      <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">
      <i class="fa fa-user-circle-o fa-4x mr-1" aria-hidden="true"></i>
        <h1 class="mt-2">Iniciar sesión</h1>
        <!-- <img src="<?= base_url() ?>/../../assets/img/Solimed.png" height="100%" width="100%"> -->
      </div>
      <div class="tx-center mg-b-60"><?php if (isset($error)) {
                                        echo $error;
                                      } ?></div>
      <p class="h5 text-center">BIENVENIDO A NUESTRO PORTAL DE PROVEEDORES</p>
      <form method="POST" action="<?php echo base_url() . '/Registro' ?>">
        <p class="text-center" style="font-size: 15px;">Inicia sesión con tu cuenta, <br> si no tienes una
          <input type="hidden" value="13" name="id_grupo">
      ...
      <form method="POST" id="form-provedor">
        ...
        <div class="form-group">
          <label for="correo" class="text-dark font-weight-bold">Email:</label>
          <div class="d-flex align-items-center">
            <i class="fa fa-user fa-2x mr-1" aria-hidden="true"></i>
            <input type="text" class="form-control" name="email" id="correo" placeholder="*Email" required>
          </div>
        </div><!-- form-group -->
        ...
        <div class="form-group">
          ...
          <div class="d-flex align-items-center">
            <i class="fa fa-lock fa-2x mr-1" aria-hidden="true"></i>
        ...
        <button type="submit" class="btn btn-solimed btn-block" style="cursor: pointer; ">Entrar</button>
        <br>
        <br>
