 ...
 <div class="sl-mainpanel">
     <div class="sl-pagebody">
         <div class="card pd-20 pd-sm-40">
             <h6 class="card-body-title">Accesos</h6>
             <p class="mg-b-20 mg-sm-b-30">Asignación de permisos por usuario, grupo y módulo.</p>
             ...
             <div class="">
                 <table id="datatable1" class="table table-responsive" style="width: 100%;">
                     <thead>
                         <tr>
                             <th class="wd-15p">MÓDULOS</th>
                             <th class="wd-15p">Crear</th>
                             <th class="wd-15p">Leer</th>
                                ...
                                foreach ($access as $acceso) {
                                    if ($acceso->id_module == $modulo->id) {
                                        ...
                                        echo "<input type='hidden' value='" . $acceso->id_group . "' name='id_group' id='id_group'>
                                                ...
                                                <td>
                                                    <button type='submit' id='' class='btn btn-primary pd-x-20'><i class='fa fa-floppy-o mr-1' aria-hidden='true'></i>Guardar</button>
                                                </form> 
                                                </td>";
                                        echo "</tr>";
