      ...
      <div class="sl-mainpanel">
          <div class="sl-pagebody">
              <div class="card pd-20 pd-sm-40">
                  <h5 class="text-dark mt-3">Perfiles</h5>
                  <div class="col-12 mb-2">
                      <button class="btn btn-success mg-b-10"><i class="fa fa-plus mr-1" aria-hidden="true"></i>Agregar grupo</button>
                  </div>
                                  ...
                                  <tr>
                                      ...
                                      <form method="POST" action="<?php echo base_url() . '/Profiles/access' ?>">
                                          ...
                                          <td>
                                              ...
                                              <button type="submit" id="" class="btn btn-teal pd-x-20"><i class="fa fa-check mr-1" aria-hidden="true"></i>Permisos</button>
                                      ...
                                      <form method="POST" action="<?php echo base_url() . '/Profiles/access' ?>">
                                          ...
                                          <td>
                                              <button type="submit" id="" class="btn btn-warning pd-x-20"><i class="fa fa-pencil mr-1" aria-hidden="true"></i>Actualizar</button>
                                              <input type="hidden" value="<?php echo $grupo->id; ?>" name="id_group" id="id_group">
                                          </td>
                                      </form>
                                      ...
                                      <form method="POST" action="<?php echo base_url() . '/Profiles/access' ?>">
                                          ...
                                          <td>
                                              ...
                                              <button type="submit" id="" class="btn btn-danger pd-x-20"><i class="fa fa-trash mr-1" aria-hidden="true"></i>Eliminar</button>
                                              <input type="hidden" value="<?php echo $grupo->id; ?>" name="id_group" id="id_group">
