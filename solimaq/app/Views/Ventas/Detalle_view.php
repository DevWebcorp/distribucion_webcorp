...
<div class="sl-mainpanel">
  ...
  <div class="sl-pagebody">
    ...
    <div class="col-md-12 row">
        ...
        <div class ="col-md-6">
          <img style="width: 100%;" src="../../../assets/img/logo.png"  alt="solimaq">
          ...
          <table id="datatable3" class="table display responsive nowrap">
            <thead>
              <tr>
                ...
                <th class="wd-10p">Fecha y Hora</th>
    ...
    <div class="col-md-4 pd-20">
      <a  target="_blank" href="<?php echo base_url()."/Ventas/tabla_detalle_view/".$id_venta;?>" class="btn btn-primary">Exportar PDF</a>
    </div>
